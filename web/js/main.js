...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('click', function (e) {
    if (e.target.closest('[data-btn-modal]')) {
      ...
      var calculatorTitle = document.querySelector('.calculator__title');
      var calcMaxValue = document.querySelector('.calculator__total-price');
      var rez;

      if (calcMaxValue) {
        rez = calcMaxValue.innerHTML.trim();
      }

      var rr;
      var textBtnModal;

      if (calculatorTitle && rez) {
        rr = calculatorTitle.innerHTML;
      ...
      switch (datTarget) {
        ...
        case 'doctorAppointment':
          modalElem = $plugins.modal({
            ...
            closable: true,
            width: '1200px',
            content: $globalHtmlElements.doctorAppointment
          });
          setTimeout(function () {
            return modalElem.open();
          }, 300);
        ...
        case 'organisationOfMedicalCare':
          modalElem = $plugins.modal({
            title: 'Организация медицинской помощи',
            closable: true,
            width: '1200px',
            content: $globalHtmlElements.organisationOfMedicalCare
          });
          setTimeout(function () {
            return modalElem.open();
          }, 300);
        ...
        case 'electronicMedicalRecord':
          modalElem = $plugins.modal({
            ...
            closable: true,
            width: '1200px',
            content: $globalHtmlElements.electronicMedicalRecord
          });
          setTimeout(function () {
            return modalElem.open();
          }, 300);
          var fillingType = document.querySelector('.fillingType');
          var numberOfRecords = document.querySelector('.numberOfRecords');
        ...
        case 'qualityAssurance':
          modalElem = $plugins.modal({
            ...
            closable: true,
            width: '1200px',
            content: $globalHtmlElements.qualityAssurance
          });
          setTimeout(function () {
            return modalElem.open();
          }, 300);
        ...
        case 'healthSpa':
          modalElem = $plugins.modal({
            ...
            closable: true,
            width: '1200px',
            content: $globalHtmlElements.healthSpa
          });
          setTimeout(function () {
            return modalElem.open();
          }, 300);
  ...
  if (myServiceTypeChange && myBtnModalTarget) {
    ...
    myServiceTypeChange.forEach(function (el, i) {
      el.addEventListener('change', function (e) {
        ...
        if (el.getAttribute('data-selectNumber') == myBtnModalTarget[i].getAttribute('data-btnNumber')) {
          // console.log(el)
          // console.log(myBtnModalTarget[i])
          if (e.target.value == 1) {
            myBtnModalTarget[i].setAttribute('data-btn-modal', 'electronicMedicalRecord');
          }
